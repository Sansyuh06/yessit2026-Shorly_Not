...
class TestBB84Simulator(unittest.TestCase):
    ...
    def test_eve_attack_detection(self):
        ...
        key, qber, attack_detected = simulate_bb84(num_bits=512, eve_present=True)
    ...
    def test_partial_interception(self):
        ...
        key, qber, attack_detected = simulate_bb84(num_bits=1024, eve_present=True)
...
class TestKeyManagementService(unittest.TestCase):
    ...
    def test_key_sharing_demo_mode(self):
        ...
        join_result = self.kms.join_session(
            session_id, "DeviceB", result.get("join_token")
        )
