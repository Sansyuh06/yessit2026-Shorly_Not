"""
ShorlyNot — CMD Event Logger (Window 2)

Connects to ws://localhost:8000/api/v1/ws/events and prints every event
...
def main():
    parser = argparse.ArgumentParser(description="ShorlyNot CMD Logger")
    parser.add_argument(
        "--url",
        default="ws://localhost:8000/api/v1/ws/events",
