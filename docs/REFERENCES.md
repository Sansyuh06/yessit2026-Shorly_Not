# REFERENCES.md — Scientific References for ShorlyNot
...
3. **Wallden, P., Dunjko, V., Kent, A., & Andersson, E.** (2015). *Quantum digital signatures with quantum-key-distribution components*. Physical Review A, 91(4), 042304. arXiv:1403.5551.
4. **Dunjko, V., Wallden, P., & Andersson, E.** (2014). *Quantum digital signatures without quantum memory*. Physical Review Letters, 112(4), 040502.
5. **Flammia, S. T., & Liu, Y.-K.** (2011). *Direct Fidelity Estimation from Few Pauli Measurements*. Physical Review Letters, 106(23), 230501. arXiv:1104.4695.
