...
class KeyManagementService:
    ...
    def _derive_aes_key(self, raw_key: bytes, pqc_secret: Optional[bytes], hkdf_salt: bytes) -> bytes:
    ...
    def join_session(self, session_id: str, device_id: str, join_token: str = None) -> Dict[str, object]:
        with self._lock:
